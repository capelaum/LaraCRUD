...
<head>
    ...
    <meta name="description" content="CRUD de Produtos em Laravel" />
        ...
        <div class="container mx-auto flex justify-between p-5 items-center">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('admin.products') }}"
                    class="inline-flex items-center bg-indigo-500 border-0 py-1 px-3 focus:outline-none hover:bg-indigo-600 rounded text-white md:mt-0">
                    Admin
